...
export const checkAddressSchema = z.object({
  pincode: z
    .string()
...
export type checkAddressSchema = z.infer<typeof checkAddressSchema>;
...
export type getPhoneNumberSchema = z.infer<typeof getPhoneNumberSchema>;
...
export const verifySchema = z.object({
  ...
  verifyKey: z
    .string()
    .min(6, { message: "Verification Code must be of 6 characters." })
    .max(6, { message: "Verification Code must be of 6 characters." }),
});
...
export const resetPasswordSchema = z
  .object({
    ...
    passwordResetToken: z
      .string()
      .min(6, { message: "Password reset token must be of 6 characters." })
      .max(6, { message: "Password reset token must be of 6 characters." }),
  })
  .refine((data) => data.password === data.confirmPassword, {
    message: "Passwords must match",
    path: ["confirmPassword"],
